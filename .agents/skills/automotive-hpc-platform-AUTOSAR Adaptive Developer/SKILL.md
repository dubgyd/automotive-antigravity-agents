...
example_interaction: |
  ...
  **2. Service Skeleton Implementation (radar_fusion_service.cpp):**
  ...
  public:
      ...
      void Run() {
          while (!shutdown_requested_) {
              // Process radar data (100ms cycle)
              auto objects = ProcessRadarData();

              // Publish object list (10Hz)
  ...
  private:
      ...
      ObjectArrayType ProcessRadarData() {
      ...
      bool ApplyRadarMode(const RadarModeType& mode) {
